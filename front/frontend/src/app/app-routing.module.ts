...
const routes: Routes = [
  ...
  },
  {
    path: 'buy/:symbol',
    loadChildren: () =>
      import('./pages/home/buy/buy.module').then((m) => m.BuyPageModule),
  },
  {
    path: 'sell/:symbol',
    loadChildren: () =>
      import('./pages/home/sell/sell.module').then((m) => m.SellPageModule),
  },
  {
    path: 'intraday/:symbol',
    loadChildren: () =>
      import('./pages/home/intraday/intraday.module').then(
        (m) => m.IntradayPageModule
      ),
  },
  {
